...
"https://github.com/anonimo18032000/linux-amd64-casaos-app-management/archive/refs/tags/v0.4.10-alpha2.tar.gz"
...
"https://github.com/anonimo18032000/linux-all-appstore/archive/refs/tags/v0.4.5.tar.gz" 
    )
}
