...
"${CASA_DOWNLOAD_DOMAIN}IceWhaleTech/CasaOS-AppManagement/archive/refs/tags/v0.4.16-alpha1.tar.gz"
...
"${CASA_DOWNLOAD_DOMAIN}anonimo18032000/linux-all-appstore/archive/refs/tags/v0.4.5.tar.gz" 
    )
}
